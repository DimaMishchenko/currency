...
extension Currency {
    public static func fractionDigits(_ code: String) -> Int {
        crypto.contains(code) ? 8 : ["BHD", "IQD", "JOD", "KWD", "LYD", "OMR", "TND"].contains(code) ? 3 : ["BIF", "CLP", "DJF", "GNF", "JPY", "KMF", "KRW", "PYG", "RWF", "UGX", "VND", "VUV", "XAF", "XOF", "XPF", "ISK"].contains(code) ? 0 : 2
    }
    public static func flag(_ code: String) -> String {
        let overrides = ["EUR": "🇪🇺", "ANG": "🇨🇼", "XCG": "🇨🇼", "XAF": "🌍", "XOF": "🌍", "XCD": "🌎", "XPF": "🇵🇫", "XDR": "🌐", "XAU": "🥇", "XAG": "🥈", "XPT": "⚪️", "XPD": "⚪️", "CNH": "🇨🇳"]
        ...
        if Locale.Region.isoRegions.contains(where: { $0.identifier == region }) {
            return String(String.UnicodeScalarView(region.unicodeScalars.compactMap { UnicodeScalar(127397 + $0.value) }))
        }
        return legacyFlag(code)
    }
    private static func legacyFlag(_ code: String) -> String {
        ["EUR": "🇪🇺", "USD": "🇺🇸", "GBP": "🇬🇧", "CZK": "🇨🇿", "CHF": "🇨🇭", "JPY": "🇯🇵", "CAD": "🇨🇦", "AUD": "🇦🇺", "PLN": "🇵🇱", "SEK": "🇸🇪", "NOK": "🇳🇴", "DKK": "🇩🇰", "HUF": "🇭🇺", "RON": "🇷🇴", "NZD": "🇳🇿", "CNY": "🇨🇳", "HKD": "🇭🇰", "SGD": "🇸🇬", "INR": "🇮🇳", "KRW": "🇰🇷", "MXN": "🇲🇽", "BRL": "🇧🇷", "ZAR": "🇿🇦", "TRY": "🇹🇷", "THB": "🇹🇭", "IDR": "🇮🇩", "ILS": "🇮🇱", "MYR": "🇲🇾", "PHP": "🇵🇭", "ISK": "🇮🇸"][code] ?? "🪙"
    }
}
...
extension InputState {
    public var destinations: [String] {
        var seen = Set<String>()
        return (savedTargets ?? [to, "GBP", "CZK", "JPY", "CHF", "BTC"]).filter {
    ...
    public mutating func useAsBase(_ code: String, book: RateBook) {
        guard code != from, Currency.codes.contains(code), let converted = book.convert(decimal, from: from, to: code) else { return }
        var value = converted
        var rounded = Decimal()
