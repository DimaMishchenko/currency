...
struct WidgetGuide: View {
  let output: (WidgetOnboardingOutput) -> Void
  ...
  var body: some View {
    NavigationStack {
      ...
      .toolbar {
        ToolbarItem(placement: .topBarTrailing) {
          Button(.WidgetOnboarding.close, systemImage: "xmark") {
            AppHaptics.play(.action); output(.closed)
          }
      ...
      .sheet(isPresented: $tutorial) {
        WidgetPresentation { WidgetTutorial(kind: .calculator) }
      }
      .sheet(isPresented: $collection) {
        WidgetPresentation { WidgetCollection() }
      }
    }
  }
...
struct WidgetPlayground: View {
  ...
  var body: some View {
    NavigationStack {
      ...
      .sheet(isPresented: $tutorial) {
        WidgetPresentation { WidgetTutorial(kind: kind, family: family) }
      }
      .sheet(isPresented: $edit) {
        WidgetPresentation { WidgetTutorial(kind: kind, family: family, editing: true) }
      }
    }
  }
